    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="账户名称" align="center" key="userName" prop="userName" v-if="columns[1].visible"
                           :show-overflow-tooltip="true"/>
          <el-table-column label="企业名称" align="center" key="nickName" prop="nickName" v-if="columns[2].visible"
                           :show-overflow-tooltip="true"/>
          <el-table-column label="企业图标" align="center" prop="avatarUrl">
            <template slot-scope="scope">
              <image-preview :src="scope.row.avatar" :height="120" :width="120">
              </image-preview>
            </template>
          </el-table-column>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="企业名称" prop="nickName">
              <el-input v-model="form.nickName" placeholder="请输入企业名称" maxlength="30"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="企业图标" prop="avatar">
              <image-upload v-model="form.avatar"
                            :limit="1"
                            :fileSize="1"
                            :fileType="['png', 'jpg', 'jpeg']"
                            :isShowTip="false"></image-upload>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <el-form-item label=" 联系电话" prop="phonenumber">
              <el-input v-model="form.phonenumber" placeholder="请输入 联系电话" maxlength="11"/>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
